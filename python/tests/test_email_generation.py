...
class TestLLMGeneration:
    ...
    def check_api_key(self):
        """Skip unless integration tests are explicitly enabled with credentials."""
        if os.environ.get("RAGMAIL_RUN_INTEGRATION_TESTS") != "1":
            pytest.skip("Set RAGMAIL_RUN_INTEGRATION_TESTS=1 to run OpenAI integration tests")
